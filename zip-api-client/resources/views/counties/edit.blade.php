                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('counties.update', $county['id']) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-700 rounded-md" required value="{{ old('name', $county['name']) }}">
                        </div>
